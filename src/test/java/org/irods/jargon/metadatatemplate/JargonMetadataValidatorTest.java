...
public class JargonMetadataValidatorTest {
	...
	public void testRequiredElementWithEmptyValue() throws Exception {
		...
		ValidationReturnEnum retVal = ValidatorSingleton.VALIDATOR.validate(irodsAccount, accessObjectFactory, me);

		Assert.assertTrue("Validator does not respect required flag", retVal == ValidationReturnEnum.VALUE_IS_REQUIRED);
	}
	...
	public void testDefaultIntWithBadValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect default validation of RAW_INT",
	...
	public void testDefaultFloatWithBadValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect default validation of RAW_FLOAT",
				retVal == ValidationReturnEnum.BAD_TYPE);
	}
	...
	public void testDefaultBooleanWithBadValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect default validation of RAW_BOOLEAN",
				retVal == ValidationReturnEnum.BAD_TYPE);
	}
	...
	public void testDefaultDateWithBadValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect default validation of RAW_DATE",
				retVal == ValidationReturnEnum.BAD_TYPE);
	}
	...
	public void testDefaultTimeWithBadValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect default validation of RAW_TIME",
				retVal == ValidationReturnEnum.BAD_TYPE);
	}
	...
	public void testDefaultDateTimeWithBadValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect default validation of RAW_DATETIME",
				retVal == ValidationReturnEnum.BAD_TYPE);
	}
	...
	public void testDefaultListOfIntWithBadValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect default validation of LIST_INT",
				retVal == ValidationReturnEnum.BAD_TYPE);
	}
	...
	public void testDefaultListOfFloatWithBadValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect default validation of LIST_FLOAT",
				retVal == ValidationReturnEnum.BAD_TYPE);
	}
	...
	public void testIsStringWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IS validation of RAW_STRING",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testIsIntWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IS validation of RAW_INT",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testIsFloatWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IS validation of RAW_FLOAT",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testIsBooleanWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IS validation of RAW_BOOLEAN",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testIsDateWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IS validation of RAW_DATE",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testIsTimeWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IS validation of RAW_TIME",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testIsDateTimeWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IS validation of RAW_DATETIME",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testIsListOfStringWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IS validation of LIST_STRING",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testIsListOfStringWithTooLongValue() throws Exception {
		...
		me.setElementName("testIsListOfString");
		me.setType(ElementTypeEnum.LIST_STRING);
		me.setCurrentValue(Arrays.asList("citius", "altius", "fortius", "another_one"));
		me.setValidationStyle(ValidationStyleEnum.IS);
		me.setValidationOptions(Arrays.asList("citius", "altius", "fortius"));
	...
	public void testIsListOfIntWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IS validation of LIST_INT",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testIsListOfFloatWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IS validation of LIST_FLOAT",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testIsListOfFloatWithTooLongValue() throws Exception {
		...
		me.setElementName("testIsListOfFloat");
		me.setType(ElementTypeEnum.LIST_FLOAT);
		me.setCurrentValue(Arrays.asList("1.618", "2.71828", "3.14159", "6.022"));
		me.setValidationStyle(ValidationStyleEnum.IS);
		me.setValidationOptions(Arrays.asList("1.618", "2.71828", "3.14159"));
	...
	public void testInListStringWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_LIST validation of RAW_STRING",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testInListIntWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_LIST validation of RAW_INT",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testInListFloatWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_LIST validation of RAW_FLOAT",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testInListDateWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_LIST validation of RAW_DATE",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testInListTimeWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_LIST validation of RAW_TIME",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testInListDateTimeWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_LIST validation of RAW_DATETIME",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testInListListOfStringWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_LIST validation of LIST_STRING",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testInListListOfIntWithValidValue() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_LIST validation of LIST_INT",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testInRangeIntWithBadValueInValidRange() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_RANGE validation of RAW_INT",
	...
	public void testInRangeIntWithBadValueInReversedRange() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_RANGE validation of RAW_INT when range values are reversed",
				retVal == ValidationReturnEnum.VALUE_NOT_IN_RANGE);
	}
	...
	public void testInRangeIntWithTooFewElementsInRange() throws Exception {
		...
		Assert.assertTrue("Validator should return NOT_VALIDATED if too few elements to define range",
				retVal == ValidationReturnEnum.NOT_VALIDATED);
	}
	...
	public void testInRangeIntWithBadValueThreeElementsInRange() throws Exception {
		...
		Assert.assertTrue("Validator should validate against range defined by first two elements",
				retVal == ValidationReturnEnum.VALUE_NOT_IN_RANGE);
	}
	...
	public void testInRangeIntWithEndpointValue() throws Exception {
		...
		Assert.assertTrue("IN_RANGE validation should succeed if value = range endpoint",
				retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testInRangeExclusiveIntWithEndpointValue() throws Exception {
		...
		Assert.assertTrue("IN_RANGE_EXCLUSIVE validation should fail if value = range endpoint",
				retVal == ValidationReturnEnum.VALUE_NOT_IN_RANGE);
	}
	...
	public void testInRangeFloatWithBadValueInValidRange() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_RANGE validation of RAW_FLOAT",
				retVal == ValidationReturnEnum.VALUE_NOT_IN_RANGE);
	}
	...
	public void testInRangeFloatWithBadValueInReversedRange() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_RANGE validation of RAW_FLOAT when range values are reversed",
				retVal == ValidationReturnEnum.VALUE_NOT_IN_RANGE);
	}
	...
	public void testInRangeDateWithBadValueInValidRange() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_RANGE validation of RAW_DATE",
				retVal == ValidationReturnEnum.VALUE_NOT_IN_RANGE);
	}
	...
	public void testInRangeDateWithBadValueInReversedRange() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_RANGE validation of RAW_DATE when range values are reversed",
				retVal == ValidationReturnEnum.VALUE_NOT_IN_RANGE);
	}
	...
	public void testInRangeTimeWithBadValueInValidRange() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_RANGE validation of RAW_TIME",
				retVal == ValidationReturnEnum.VALUE_NOT_IN_RANGE);
	}
	...
	public void testInRangeTimeWithBadValueInReversedRange() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_RANGE validation of RAW_TIME when range values are reversed",
				retVal == ValidationReturnEnum.VALUE_NOT_IN_RANGE);
	}
	...
	public void testInRangeTimeWithEndpointValue() throws Exception {
		...
		Assert.assertTrue("IN_RANGE validation should fail if value = range endpoint",
				retVal == ValidationReturnEnum.VALUE_NOT_IN_RANGE);
	}
	...
	public void testInRangeDateTimeWithBadValueInValidRange() throws Exception {
		...
		Assert.assertTrue("Validator does not respect IN_RANGE validation of RAW_DATETIME",
				retVal == ValidationReturnEnum.VALUE_NOT_IN_RANGE);
	}
	...
	public void testRegexStringWithValidValue() throws Exception {
		...
		Assert.assertTrue("REGEX validation should succeed", retVal == ValidationReturnEnum.SUCCESS);
	}
	...
	public void testRegexStringWithInvalidValue() throws Exception {
		...
		Assert.assertTrue("REGEX validation should fail", retVal == ValidationReturnEnum.REGEX_FAILED);
	}
	...
	public void testFollowRefUrlWithValidRef() throws Exception {
		...
		Assert.assertTrue("FOLLOW_REF validation should succeed; URL is valid", retVal == ValidationReturnEnum.SUCCESS);
	}
