...
public class VirtualCollectionProfileUtils {
	 ...
	 *         found
	 */
	public static AbstractVirtualCollection findVirtualCollectionInTempQueries(final String uniqueName,
		...
		if (userVirtualCollectionProfile == null) {
			throw new IllegalArgumentException("null userVirtualCollectionProfile");
		}

		AbstractVirtualCollection foundCollection = null;

		for (AbstractVirtualCollection collection : userVirtualCollectionProfile.getUserRecentQueries()) {
	 ...
	 *         found
	 */
	public static AbstractVirtualCollection findVirtualCollectionInUserHomeQueries(final String uniqueName,
			final UserVirtualCollectionProfile userVirtualCollectionProfile) {
		...
		for (AbstractVirtualCollection collection : userVirtualCollectionProfile.getUserHomeCollections()) {
			if (collection.getUniqueName().equals(uniqueName)) {
				foundCollection = collection;
				break;
			}
	 ...
	 *         found
	 */
	public static AbstractVirtualCollection findVirtualCollectionInAnyUserVirtualCollection(final String uniqueName,
			final UserVirtualCollectionProfile userVirtualCollectionProfile) {
		...
		AbstractVirtualCollection foundCollection = findVirtualCollectionInUserHomeQueries(uniqueName,
				userVirtualCollectionProfile);

		if (foundCollection == null) {
			foundCollection = findVirtualCollectionInTempQueries(uniqueName, userVirtualCollectionProfile);
		}
