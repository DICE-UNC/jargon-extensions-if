...
public enum ElementTypeEnum {
	RAW_STRING, RAW_TEXT, RAW_URL, RAW_INT, RAW_FLOAT, RAW_BOOLEAN, RAW_DATE, RAW_TIME, RAW_DATETIME, REF_IRODS_QUERY, REF_IRODS_CATALOG, REF_URL, LIST_STRING, LIST_INT, LIST_FLOAT
}
